        ...
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand demo">
                    <a href="/posts" class="app-brand-link">
                        ...
                        <span class="app-brand-text demo menu-text fw-bolder ms-2">Blogger</span>
                    </a>
                        ...
                        <ul class="navbar-nav flex-row align-items-center ms-auto">
                            ...
                            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                                <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);"
                                    ...
                                    <div class="avatar">
                                        <img src="{{ asset('assets/img/avatars/avatar-1.png') }}" alt
                                    ...
                                    <li>
                                        <form action="/logout" method="post">
                                            ...
                                            <a class="dropdown-item">
                                                ...
                                                <button type="submit" class="p-0 border-0">Log Out</button
                                                    type="submit">
                                            </a>
                                        </form>
                                    </li>
